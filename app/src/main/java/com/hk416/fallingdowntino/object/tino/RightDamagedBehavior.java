...
public class RightDamagedBehavior extends SpriteAnimeObject {
    private static final String TAG = RightDamagedBehavior.class.getSimpleName();
    ...
    public RightDamagedBehavior(@NonNull Player player) {
        super(
                BITMAP_RES_IDS,
                Tino.WIDTH,
                Tino.HEIGHT,
